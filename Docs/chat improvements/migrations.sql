...
-- Example policy for user_memories (users can only see their own)
-- CREATE POLICY "Users can view own memories" ON user_memories
--   FOR SELECT USING (auth.uid() = user_id);

-- CREATE POLICY "Service role can manage all memories" ON user_memories
...
-- ===========================================
-- 10. SCHEDULED JOBS (Optional - requires pg_cron)
-- ===========================================

-- Uncomment if you have pg_cron enabled:
-- SELECT cron.schedule('update-memory-recency', '0 3 * * *', 'SELECT update_memory_recency()');
