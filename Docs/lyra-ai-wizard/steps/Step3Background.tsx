      ...
      <div>
        ...
        <div className="mt-3">
          <input
            ...
            className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-purple-500 text-white placeholder-gray-500 text-sm"
          />
        </div>
      </div>
