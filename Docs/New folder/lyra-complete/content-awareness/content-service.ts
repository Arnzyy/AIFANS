...
function extractKeywords(text: string): string[] {
  ...
  const patterns = {
    colors: ['red', 'black', 'white', 'pink', 'blue', 'green', 'purple', 'gold', 'silver'],
    outfits: ['bikini', 'lingerie', 'dress', 'swimsuit', 'bra', 'panties', 'lace', 'leather', 'silk'],
    settings: ['bedroom', 'bed', 'pool', 'beach', 'mirror', 'bathroom', 'studio', 'couch', 'sofa'],
    poses: ['lying', 'standing', 'sitting', 'kneeling', 'bent', 'back', 'side'],
    moods: ['sexy', 'hot', 'cute', 'playful', 'sultry', 'fierce', 'innocent', 'naughty'],
...
function calculateMatchScore(
  ...
  // Recency indicators
  if (lowerRef.includes('latest') || lowerRef.includes('recent') || lowerRef.includes('new')) {
