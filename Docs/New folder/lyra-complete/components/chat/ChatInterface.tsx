...
export function ChatInterface({ creator, initialMessages = [] }: ChatInterfaceProps) {
  ...
  const handleContentMention = (content: any) => {
    setInput(prev => prev + ` [about your ${content.type}: ${content.title || 'recent post'}] `);
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-full focus:outline-none focus:border-purple-500 text-white placeholder-gray-500"
              disabled={isLoading}
            />
          </div>
