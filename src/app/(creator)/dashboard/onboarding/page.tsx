...
const steps: { id: OnboardingStep; label: string; icon: React.ComponentType<{ size?: number }> }[] = [
  { id: 'account_type', label: 'Account Type', icon: Building },
  { id: 'identity', label: 'Identity', icon: User },
  { id: 'stripe_connect', label: 'Payments', icon: CreditCard },
      ...
      <div className="bg-zinc-900 rounded-xl p-8">
        ...
        {currentStep === 'identity' && (
          <div className="space-y-6">
            ...
            <p className="text-zinc-400">This is how you'll appear to fans</p>
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-zinc-800">
          ...
          <button
            onClick={saveStep}
            disabled={saving || (currentStep === 'identity' && !formData.display_name)}
