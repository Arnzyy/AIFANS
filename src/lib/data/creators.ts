...
export const mockCreators: Creator[] = [
  ...
  },
  {
    ...
    displayName: 'Nova',
    age: 23,
    avatar: '/creators/nova.png',
    bio: 'City nights & neon lights. Catch me on the late train. Bold, unapologetic & always moving.',
    location: 'Neon City',
    ...
    isVerified: true,
    hasAiChat: true,
    tags: ['Dark Hair', 'Bold', 'Confident', 'Casual', 'Slim'],
    contentRating: 'suggestive',
    modelType: 'creator_model',
    isNew: true,
  },
